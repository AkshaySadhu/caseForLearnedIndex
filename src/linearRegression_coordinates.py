...
data_path = "../data/sydneyUniqueSortedLatitudes.csv"  # Replace with your file path
...
ranges = [(-50, -34.3), (-34.3, -33.52), (-33.55, -10)]  # Example ranges, customize as needed
case_polynomials = {}
...
test_path = "../data/sydneyUniqueSortedLatitudes.csv"  # Replace with your test data path
